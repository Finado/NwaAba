        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                    <div class="inner">
                        <h3><?=count($users);?></h3>
                        <p><a href="#" style="color: #fff">Users</a></p>
                    </div>
                    <div class="icon">
                        <i class="ion ion-person-add"></i>
                    </div>
                    <a href="<?=base_url()?>index.php/Admin/Users" style="color: #fff" class="small-box-footer">View
                        Users <i
                            class="fa
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        ...
                        <p><a href="#" style="color: #fff">Companies</a></p>
                    </div>
                    <div class="icon">
                        <i class="ion ion-ios-briefcase"></i>
                    </div>
                    <a href="<?=base_url()?>index.php/Admin/ManageCompany" style="color: #fff"
                       class="small-box-footer">View Companies <i class="fa
                    fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    ...
                    <a href="<?=base_url()?>index.php/Admin/ManageJobs" style="color: #fff" class="small-box-footer">View Jobs
                        <i class="fa
                    fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-red">
                    ...
                    <a href="<?=base_url()?>index.php/Admin/ManageProperty" class="small-box-footer">View Properties <i
