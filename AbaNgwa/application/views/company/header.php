...
<div class="wrapper">
    ...
    <header class="main-header navbar-default navbar-fixed-top" style="background: green !important;">
        <!-- Logo -->
    ...
    <aside class="main-sidebar" style="background-color: #000000 !important; color: #47ffda !important; margin-top: 50px !important;">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="" >
                    <a href="<?=base_url()?>index.php/Admin/Users" style="color: #ffffff !important;">
                        <i class="fa fa-users"></i>
                        <span style="color: #ffffff !important;">Users</span>
                        <!-- <i class="fa fa-circle-o pull-right"></i>-->
                    </a>
               ...
               <!-- <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?=base_url()?>index.php/Admin/BasicInfo" style="color: #ffffff !important;"> <i class="fa fa-circle-o text-red"></i>Add</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?=base_url()?>index.php/Admin/Products" style="color: #ffffff !important;"> <i class="fa fa-circle-o text-red"></i>Manage</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?=base_url()?>index.php/Admin/Orders" style="color: #ffffff !important;"> <i class="fa fa-circle-o text-red"></i>Manage</a></li>
                ...
                <li class="">
                    <a href="<?=base_url()?>index.php/Admin/CompanyLogo" style="color: #ffffff !important;">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?=base_url()?>index.php/Admin/AddProperty" style="color: #ffffff !important;"> <i class="fa fa-circle-o text-red"></i>Add</a></li>
                        <li><a href="<?=base_url()?>index.php/Admin/ManageProperty" style="color: #ffffff !important;"> <i class="fa fa-circle-o text-red"></i>Manage</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?=base_url()?>index.php/Admin/AddCompany" style="color: #ffffff !important;"> <i class="fa fa-circle-o text-red"></i>Add</a></li>
                        <li><a href="<?=base_url()?>index.php/Admin/ManageCompany" style="color: #ffffff !important;"> <i class="fa fa-circle-o text-red"></i>Manage</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?=base_url()?>index.php/Admin/Products" style="color: #ffffff !important;"> <i class="fa fa-circle-o text-red"></i>Add</a></li>
                        <li><a href="<?=base_url()?>index.php/Admin/ManageProducts" style="color: #ffffff !important;"> <i class="fa fa-circle-o text-red"></i>Manage</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?=base_url()?>index.php/Admin/AddJob" style="color: #ffffff !important;"> <i class="fa fa-circle-o text-red"></i>Add</a></li>
                        <li><a href="<?=base_url()?>index.php/Admin/ManageJobs" style="color: #ffffff !important;"> <i class="fa fa-circle-o text-red"></i>Manage</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?=base_url()?>index.php/Admin/AddNews" style="color: #ffffff !important;"> <i class="fa fa-circle-o text-red"></i>Add</a></li>
                        <li><a href="<?=base_url()?>index.php/Admin/ManageNews" style="color: #ffffff !important;"> <i class="fa fa-circle-o text-red"></i>Manage</a></li>
