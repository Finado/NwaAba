    ...
    <div class="container">
        <div class="ten columns">
            <div class="resume-titlebar">
                ...
                <div class="resumes-list-content">
                    <h4 style="color: #ffffff"> <span style="color: #ffffff"> </span></h4>
        ...
        <div class="six columns">
            <div class="two-buttons">
                ...
                <a href="#small-dialog" class="popup-with-zoom-anim button"><i class="fa fa-envelope"></i> Contact
                    Owner</a>

                <div id="small-dialog" class="zoom-anim-dialog mfp-hide apply-popup">
                    <div class="small-dialog-headline">
                        <h2>Send Message to <br> Owner</h2>
                    </div>
...
<div class="container">
    ...
    <div class="seven columns">
        ...
        <h3 class="margin-bottom-20">Location: <?=$pro['Location'];?></h3>
