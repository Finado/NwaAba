    ...
    <div class="container">
        <div class="ten columns">
            ...
            if($num == 1){
                ...
                echo '<span style="color: #ffffff">We found '. $num .' job </span>';


            }elseif($num > 1){
                echo '<span style="color: #ffffff">We found '. $num .' jobs </span>';
            }else{
                echo '<span style="color: #ffffff">We found '. $num .' job </span>';
            }
            ?>
    ...
    <div class="fifteen columns">
        <div class="padding-right">
            ...
            <form action="<?=base_url()?>index.php/home/search" method="post" class="list-search">
                ...
                <input type="text" name="keyword" required="required" placeholder="Find Job by title, location" />
            ...
            if($num < 1){
            ?>
            <div class="alert alert-danger">No match found for <?=$keys;?></div>
            <?php
            };
            ?>
            ...
            <ul class="job-list full">
                ...
                if($num == 1){
                    ...
                    echo '<h3 class="margin-bottom-25">' .$num .' Job</h3>';


                }elseif($num > 1){
                    echo '<h3 class="margin-bottom-25">' .$num . ' Jobs </h3>';
                }else{
                    echo '';
                }
                ?>
                ...
                foreach($jobs as $job):
                    ...
                    <li><a href="<?=base_url()?>index.php/Home/Jobdetails/<?=$job['Id'];?>">
                            ...
                            <div class="job-list-content">
                                <h4><?=$job['Title'];?> - franconet <span class="full-time">Apply</span></h4>
                                <div class="job-icons">
