...
<div id="titlebar">
    <div class="container">
        <div class="ten columns">
            <span style="color: #ffffff">We found <?=count($products);?> Products </span>
            <h2 style="color: #ffffff">Products</h2>
        </div>

        <div class="six columns">
            <a href="<?=base_url()?>index.php/User/Products" class="button">Post a Product, It's Free!</a>
            ...
            <div class="container">
                <div class="row">
                    <div class="sixteen columns">
                        <h3 class="margin-bottom-25">All Products</h3>
                    </div>
                    ...
                    foreach($products as $pro):
                        ...
                        <div class="one-third column wow fadeInDown" style="margin-left: -2px !important;" >
                            ...
                            <div class="recent-post">
                                <div class="recent-post-img"><a href="../Home/ProductDetails/<?=$pro['Id'];?>"><img src="<?=base_url()?>assets/uploads/<?=$pro['Image'];?>" alt="" style="height: 250px !important; width: 400px !important;"></a><div class="hover-icon"></div></div>
                                <a href="blog-single-post.html"><h4><?=$pro['Title'];?></h4></a>
                                <div class="meta-tags">
                                    <!--<span>October 10, 2015</span>-->
                                    <span><a href="#"><?=$pro['Price'];?></a></span>
                                </div>
                                <p><?=$pro['Description'];?></p>
                                <a href="../Home/ProductDetails/<?=$pro['Id'];?>" class="button">View Details</a>
                            </div>
