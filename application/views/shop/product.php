			...
			<div class="product-right-top">
					...
					<div class="col-md-4 chain-grid  simpleCart_shelfItem">
						<div class="grid-span-1">
							<a href="<?php echo base_url().'product/detail/'.$product['Id']?>"><img class="img-responsive "
								src="<?php echo base_url();?>assets/uploads/<?=$product['Image']?>" alt=" ">
								<div class="link">
									<ul>
						...
						<div class="grid-chain-bottom ">
							...
							<div class="star-price">
								...
								<div class="price-at-bottom ">
									<span class="item_price" style="color: #000">&#x20A6 <?php echo $product['Price'];?></span>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="cart-add">
